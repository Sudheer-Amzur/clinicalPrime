...
export class RuleListComponent implements OnInit {
   ...
   Rules: RuleList[]
      cols: any[];
      Listdata:any[];
  constructor( public router:Router,private message: MessageService) { this.message.changeMessage("Rule-List"); }
  ...
  this.cols = [
     ...
     GotoRulesConfiguration()
        ...
        exportToExcel(dt: DataTable) {    
          var t: DataTable = dt;
          var c = dt.columns;
          t.columns = t.columns.slice(0, 4);
          t.exportCSV();
          t.columns =c;
        }
}